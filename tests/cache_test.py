...
class TestSSMCache(TestBase):
    ...
    @patch('ssm_cache.ssm.SSMParameterStore.SESSION_FACTORY', new=None)
    @patch('ssm_cache.ssm.SSMParameterStore.CLIENT_FACTORY', new=None)
